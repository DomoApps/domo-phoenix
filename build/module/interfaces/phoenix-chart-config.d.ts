...
export declare type NumberFormat = 'default' | 'number' | 'currency' | 'percentage';
export declare type ColumnAlignment = "LEFT" | "RIGHT" | "CENTER";
export declare enum TableColumnAlignment {
    left = "left",
    right = "right",
    center = "center"
}
export declare type ColumnMapping = "ITEM" | "VALUE" | "SERIES" | "HOVER" | "BUBBLESIZE" | "GROUP1" | "GROUP2" | "COLUMN" | "ROW" | "EXTRAINFO1" | "EXTRAINFO2" | "EXTRAINFO3" | "CATEGORY" | "XTIME" | "VALUE1" | "VALUE2" | "RANGE1" | "RANGE2" | "RANGE3" | "SEGMENTS" | "CATEGORY1" | "CATEGORY2" | "CATEGORY3" | "CATEGORY4" | "CATEGORY5" | "TARGET" | "MEDIAN" | "UPPER" | "LOWER" | "CURRENT" | "DATE" | "EVENT" | "HIGH" | "LOW" | "OPEN" | "CLOSE" | "MIN" | "MAX" | "PREVIOUS" | "DATE" | "MEDIAN2" | "LOWER2" | "UPPER2" | "OUTLIERS" | "START_DATE" | "END_DATE" | "PERCENT_COMPLETE" | "HIGH" | "LOW" | "LABEL" | "LATITUDE" | "LONGITUDE" | "LATITUDE2" | "LONGITUDE2" | "COUNTRY" | "COLOR" | "ANNOTATION_DATE" | "POP_PERIOD" | "POP_INDEX";
export declare type Aggregation = "AVG" | "COUNT" | "MAX" | "MIN" | "SUM" | "STDDEV_POP" | "VAR_POP" | "APPROXIMATE_COUNT_DISTINCT" | "APPROXIMATE_COUNT_DISTINCT_SYNOPSIS" | "APPROXIMATE_COUNT_DISTINCT_OF_SYNOPSIS";
export declare type DateTimeElement = "MINUTE" | "HOUR" | "DAY" | "WEEK" | "MONTH" | "QUARTER" | "YEAR" | "NONE";
export declare type FilterType = "CALENDAR" | "COLUMN_ID" | "CARD_FORMULA_ID" | "FORMULA_ID" | "LEGACY" | "UNSUPPORTED";
...
export declare type TableAggregation = 'SUM' | 'COUNT';
...
export declare enum DataCalculation {
...
export declare type ColorPaletteRule = {
    min: number;
    max: number;
    values: number[][];
};
export declare type ColorPaletteData = {
    id: string;
...
declare type TextStyle = "PLAIN" | "ITALIC" | "BOLD" | "BOLD_ITALIC" | "MEDIUM" | "MEDIUM_ITALIC" | "LIGHT" | "LIGHT_ITALIC" | "UNDERLINE";
declare type Format = {
    color?: string;
    textColor?: string;
    textStyle?: TextStyle;
...
export declare type ConditionalFormat = {
    id?: string;
    cardId?: string;
    dataSourceId?: string;
    format: Format;
...
export declare type ChartDataSourceData = {
    datasource: string;
...
export declare type ChartDataSource = {
